        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className=" mt-3 p-4 w-full md:w-2/3 text-gray-800">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <button
                className="block w-full border border-blue-600 bg-transparent hover:bg-blue-600 hover:text-white text-blue-600 font-bold py-3 rounded-lg transition-colors text-center"
              >
                Analyze your Policy
              </button>
            </div>
